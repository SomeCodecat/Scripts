...
echo "Example usage:"
echo "  $DEST_DIR/backup_stacks.sh -u https://portainer.local:9443 -k your_api_key --backup-envs --timestamps"
echo ""
echo "For help with all options:"
echo "  $DEST_DIR/backup_stacks.sh --help"
echo ""
